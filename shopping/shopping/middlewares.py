    ...
    def process_request(self, request, spider):
        ...
        try:
            ...
            if page > 1:
                ...
                submit.click()
            self.wait.until(EC.text_to_be_present_in_element((By.CSS_SELECTOR, '.current'), str(page)))
            self.wait.until(EC.presence_of_element_located((By.CSS_SELECTOR, '#component_59')))
